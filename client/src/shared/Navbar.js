...
const hamburger = <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" > <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /> </svg>
...
const Navbar = () => {
  ...
  const menuItems = (
    <>
      ...
      <li >
        <Link className="active:bg-accent" to="/products">Products</Link>
      </li>
      <li >
      ...
      <div className="navbar container mx-auto">
        ...
        <div className="navbar-start">
          <div className="dropdown">
            <label tabIndex="0" className="btn btn-ghost lg:hidden">{hamburger}</label>
